...
public class HistoryIndentFragment extends BaseLazyIndentFragment {
                        ...
                        public void onResponse(String s) {
                            ...
                            if (newDatas != null && !newDatas.isEmpty()) {
                                ...
                                for (int i = 0; i < newDatas.size(); i++) {
                                    if (newDatas.get(i).getIndenttype().equals("购买完成")) {
                                        mRecycleDetas.add(newDatas.get(i));
                                    }
                                }
                                // 根据时间日期大小对订单信息排序(这里最好是在数据库查出来就排好序，减少客户端压力)
                                IndentInfoBean bean;
                                ...
                                if (mRecycleDetas.size() == 0) {
                                    ...
                                    textViewNullText.setText("无购买成功订单");
                                } else {
